    ...
    <main className="min-h-screen bg-[#2B2A2A] flex items-center justify-center p-4 relative">
      ...
      <div className="relative bg-white p-8 max-w-md w-full shadow-[0_0_60px_rgba(255,255,255,0.15)]" style={{ zIndex: 2 }}>
        ...
        <div className="mt-6 pt-6 border-t border-gray-200 text-center space-y-3">
          ...
          <p className="text-gray-400 text-xs">לבירורים ניתן לפנות לאיציק <a href="tel:0502022222" className="text-[#007272] hover:text-[#009999] transition">050-202-2222</a><br />או לאריק <a href="tel:0545243335" className="text-[#007272] hover:text-[#009999] transition">054-524-3335</a></p>
        </div>
      </div>
    </main>
  )
